		...
		<ul
				...
				<div id="collapseUtilities" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item"
							...
							class="collapse-item" href="/apa/admin/company/entry/pharmacy.do">약국
							회원</a>
					</div>
				</div></li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="/apa/admin/advice/list.do">게시글</a>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">${dto.userName}(${dto.userId})님</span>
						...
						<div class="col-xl-12">
							<div class="card shadow mb-5">
								...
								<div
									...
									<h5 class="m-0 font-weight-bold text-primary">의학상담</h5>
								</div>
								<!-- Card Body -->
								<div class="card-body">
									<form method="POST" action="/apa/admin/advice/list.do">
										<div id="adminAdvice">
											<div id="adminCounsel">
												<table id="list">
													<tr>
													...
													<c:forEach items="${list}" var="dto">
														<tr>
															<td>${dto.adviceSeq}</td>
															<td id="questionTitle"><a
																href="/apa/admin/advice/view.do?seq=${dto.adviceSeq}&search=${map.search}&column=${map.column}&word=${map.word}">${dto.adviceTitle}
															</a></td>
															<td>${dto.userId}</td>
															<td>${dto.adviceRegdate}</td>
															<td>${dto.isAnswer}</td>
														</tr>
													</c:forEach>
