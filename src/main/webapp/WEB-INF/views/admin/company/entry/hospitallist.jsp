			...
			<div class="enttbl">
				<table>
					<tr>
						...
						<th id="date">신청일자</th>
						<th id="status">현황</th>
						<th id="status">처리날짜</th>
					</tr>
					<c:forEach items="${hospitalList}" var="dto" varStatus="status">
		 				<tr>
							<td>${status.count}</td>
							<td><a href="/apa/admin/company/entry/hospitalview.do?hospitalId=${dto.hospitalId}">${dto.hospitalId}</a></td>
							<td>${dto.hospitalName}</td>
							<td>${dto.hospitalregdate}</td>
