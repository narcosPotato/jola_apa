                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">사후 처리</h5>
                                </div>
			...
			<div class="afttbl">
				<table>
					<tr>
						...
						<th id="type">아이디</th>
						<th id="id">병원이름</th>
						<th id="percentage">부정 태그 비율</th>
						<th id="regdate">가입일자</th>
						<th id="status">입점여부</th>
						<th id="work">처리현황</th>
					</tr>
					<c:forEach items="${list}" var="dto" varStatus="status">
 		 				<tr>
							...
							<td><a href="/apa/admin/company/after/view.do?hospitalId=${dto.hospitalId}">${dto.hospitalName}</a></td>
							<td>${dto.negativePercentage}%</td>
							<td>${dto.regdate}</td>
							<td>${dto.isHospital}</td>
							<td>${dto.isHospital == 'n' ? '완료' : '대기'}</td>
						</tr>
					</c:forEach>
				</table>
