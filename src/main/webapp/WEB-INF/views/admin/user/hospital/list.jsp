                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">병원 회원 목록</h5><button id="btn"><a href="/apa/admin/info/view.do">수정</a></button>
                                </div>
				...
				<table>
					...
					<c:forEach items="${list}" var="dto" varStatus="status">
						<tr>
							...
							<td>${dto.hospitalId}</td>		<!-- 아이디 -->
							<td><a href="/apa/admin/user/hospital/view.do?hospitalId=${dto.hospitalId}">${dto.hospitalName}</a></td>	<!-- 회원명 -->
							<td>${dto.hospitalSSN}</td>		<!-- 사업자등록번호 -->
							<td>${dto.hospitalAddress}</td>	<!-- 주소 -->
							<td>${dto.regdate}</td>			<!-- 가입 일자 -->
							<td>${dto.isHospital}</td>		<!-- 입점 유무 -->
						</tr>
					</c:forEach>
				</table>
			</div>
