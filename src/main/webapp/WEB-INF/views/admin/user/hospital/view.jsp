...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/apa/admin/user/hospital/list.do">병원 회원</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	                ...
	                <div class="d-sm-flex align-items-center justify-content-between mb-4">
	                	<h1 class="h3 mb-0 text-gray-800 hansans" style="padding-top: 28px;">병원 회원</h1>
	                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">병원 회원 상세보기</h5><button id="btn"><a href="apa/admin/user/hospital/edit.do?hospitalId=${dto.hospitalId}">수정</a></button>
                                </div>
                                
			<!-- Card Body -->
		
			<div>
				<button id="btn"><a href="/apa/admin/user/hospital/edit.do?hospitalId=${dto.hospitalId}">수정</a></button>
			...
			<div>
				<button id="btn"><a href="/apa/admin/user/hospital/list.do">목록</a></button>
			</div>
	...
	function openDeletePopup() {
        ...
        var deleteUrl = "/apa/admin/user/hospital/del.do?hospitalId=${dto.hospitalId}";
        var deletePopup = window.open(deleteUrl, "DeleteUserPopup", "width=500, height=400");
        
        // 팝업이 닫힌 경우 실행되는 함수
        function onPopupClose() {
            // 삭제가 완료되면 목록 페이지로 이동
            window.location.href = "/apa/admin/user/hospital/list.do";
        }
