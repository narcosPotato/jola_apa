                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">신고 목록</h5> <button id="btn"><a href="/apa/admin/user/general/generalmain.do">돌아가기</a></button>
                                </div>
				...
				<table class=report>
					...
					<c:forEach items="${list}" var="dto" varStatus="status">
						<tr class="report-row">
							...
							<td>${dto.reportUserId}</td>	<!-- 아이디 -->
							<td>${dto.reportUserName}</td>	<!-- 회원명 -->
							<td>${dto.regdate}</td>			<!-- 신고일자 -->
							<td>${dto.reportType}</td>		<!-- 신고유형 -->
							<td>${dto.isReportState}</td>	<!-- 신고현황 -->
							<td>${dto.reportCount}</td>		<!-- 신고횟수 -->
