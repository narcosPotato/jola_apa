                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">회원 목록</h5> <button id="btn"><a href="/apa/admin/user/general/generalmain.do">돌아가기</a></button>
                                </div>
				...
				<table class="user">
					...
					<c:forEach items="${list}" var="dto" varStatus="status">
						<tr>
							...
							<td><a href="/apa/admin/user/general/view.do?userSeq=${dto.userSeq}">${dto.userName}</a></td>	<!-- 회원명 -->
							<td>${dto.userSSN}</td>		<!-- 주민등록번호 -->
							<td>${dto.userTel}</td>		<!-- 연락처 -->
							<td>${dto.userAddress}</td>	<!-- 주소 -->
							<td>${dto.userEmail}</td>	<!-- 이메일 -->
							<td>${dto.registerDate}</td>	<!-- 가입 일자 -->
							<td>${dto.isUserUnregister}</td>	<!-- 탈퇴 유무 -->
						</tr>
					</c:forEach>
				</table>
			</div>
