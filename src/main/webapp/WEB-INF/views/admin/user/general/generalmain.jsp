...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<h3>회원 정보</h3>
			<div><button id="btn"><a href="/apa/admin/user/general/list.do">상세보기</a></button></div>
	        ...
	        <div class="ustbl">
				...
				<div><button id="btn"><a href="/apa/admin/user/general/black/list.do">상세보기</a></button></div>
				...
				<div><button id="btn"><a href="/apa/admin/user/general/report/list.do">상세보기</a></button></div>
