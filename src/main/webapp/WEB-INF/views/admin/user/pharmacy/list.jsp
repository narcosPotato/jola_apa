        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">약국 회원 목록</h5>
                                </div>
			...
			<table class="pharmacy">
				<tr>
					...
					<th id="isprescription">처방약 제조유무</th>
					<th id="status">입점 유무</th>
				</tr>
				<c:forEach items="${list}" var="dto" varStatus="status">
					<tr>
						<td>${status.count}</td>	<!-- 순번 -->
						<td>${dto.pharmacyId}</td>		<!-- 아이디 -->
						<td><a href="/apa/admin/user/pharmacy/view.do?pharmacyId=${dto.pharmacyId}">${dto.pharmacyName}</a></td>	<!-- 회원명 -->
						<td>${dto.pharmacySSN}</td>		<!-- 사업자등록번호 -->
						<td>${dto.pharmacyAddress}</td>	<!-- 주소 -->
						<td>${dto.regdate}</td>			<!-- 가입 일자 -->
						<td>${dto.isDispense}</td>		<!-- 처방약 제조 유무 -->
						<td>${dto.isPharmacy}</td>		<!-- 입점 유무 -->
					</tr>
				</c:forEach>
			</table>
