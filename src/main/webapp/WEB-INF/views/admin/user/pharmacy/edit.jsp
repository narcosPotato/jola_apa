            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="/apa/admin/user/pharmacy/list.do">약국 회원</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	                ...
	                <div class="d-sm-flex align-items-center justify-content-between mb-4">
	                	<h1 class="h3 mb-0 text-gray-800 hansans" style="padding-top: 28px;">약국 회원</h1>
	                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">약국 회원 수정하기</h5>
                                </div>
                                
			<!-- Card Body -->
			
			<form method="POST" action="/apa/admin/user/pharmacy/edit.do">
			<div>
				<button>수정완료</button>
			</div>
			...
			<div class="phartbl">
				<table class=info>
					...
					<tr>
						<th id="id">비밀번호</th>
						<td><input type="text" name="pharmacyPw" id="pharmacyPw" required class="full" value="${dto.pharmacyPw}"></td>
					</tr>
					<tr>
						<th id="pharmacyname">약국명</th>
						<td><input type="text" name="pharmacyName" id="pharmacyName" required class="full" value="${dto.pharmacyName}"></td>
					</tr>
					<tr>
					...
					<tr>
						<th id="status">처방약 제조 유무</th>
						<td>${dto.isDispense}</td>
					</tr>
					<tr>
						<th id="status">입점 유무</th>
						<td><input type="text" name="isPharmacy" id="isPharmacy" required class="full" value="${dto.isPharmacy}"></td>
					</tr>
				</table>
			</div>
			
			<div>
				<button id="btn"><a href="/apa/admin/user/pharmacy/list.do">목록</a></button>
			</div>
			
			<input type="hidden" name="pharmacyId" value="${dto.pharmacyId}">
			</form>
