...
<body id="page-top">
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">약국 회원 상세보기</h5>
                                </div>
                                
			<!-- Card Body -->

			<div>
				<button id="btn"><a href="/apa/admin/user/pharmacy/edit.do?pharmacyId=${dto.pharmacyId}">수정</a></button>
				<button id="btn" onclick="openDeletePopup();">삭제</button>
			</div>
	...
	function openDeletePopup() {
        ...
        var deleteUrl = "/apa/admin/user/pharmacy/del.do?pharmacyId=${dto.pharmacyId}";
        var deletePopup = window.open(deleteUrl, "DeleteUserPopup", "width=500, height=400");
        
        // 팝업이 닫힌 경우 실행되는 함수
        function onPopupClose() {
            // 삭제가 완료되면 목록 페이지로 이동
            window.location.href = "/apa/admin/user/pharmacy/list.do";
        }
