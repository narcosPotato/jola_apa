			...
			<li class="nav-item active"><a class="nav-link" href="#"
				...
				<div id="collapseUtilities3" class="collapse show"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item sidebar-clicked" href="/apa/hospital/document/list.do">서류요청</a>
					</div>
				</div></li>
				...
				<nav
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800 hansans"
							style="padding-top: 28px;">서류요청</h1>
					</div>
						...
						<div class="col-xl-12 col-lg-7 rgst-div">
							<div class="card shadow mb-4">
								...
								<div
									...
									<h5 class="m-0 font-weight-bold text-primary">요청된 서류</h5>
								</div>
								<!-- Card Body -->
								<div class="card-body">
