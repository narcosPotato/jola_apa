...
<body id="page-top">
						...
						<div class="col-xl-12">
							<div class="card shadow mb-4">
								...
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">제조 완료</h6>
    ...
    $("#finishBtn").click(function () {
        ...
        if (selectedDispenseIds.length > 0) {
            ...
            var isCompleted = confirm("선택한 항목을 수령 완료하시겠습니까?");

            if (isCompleted) {
                // AJAX 요청을 통해 서버에 수령 완료 요청 전송
                $.ajax({
                    type: "POST",
                    url: "/apa/pharmacy/dispense/completefinish.do",
                    data: { dispenseIds: selectedDispenseIds },
                    traditional: true,
                    success: function (response) {
                        if (response === "Success") {
                            alert("성공적으로 수령 완료되었습니다.");
                            location.reload(); 
