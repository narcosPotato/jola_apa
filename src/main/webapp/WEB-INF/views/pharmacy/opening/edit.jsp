...
<body id="page-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
								...
								<div class="card-body">
									<div id="open-info">
										<form id="update-form" method="POST" action="/apa/pharmacy/opening/edit.do?pharmacyId=${pharmacyId}">
											...
											<div id="open-update-btn">
												<button type="button" id="update-btn" onclick="confirmAndUpdate()">수정완료</button>
    ...
    function confirmAndUpdate() {
        // 사용자에게 확인 메시지를 보여주고 확인 버튼이 눌리면 true 반환
